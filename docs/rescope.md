...
- **Harness runtime identifiers.** Exact `cordis/...` event names, `cordis` locale and catalog keys, and the `cordis` agent-preset id are product data rather than package references.
